                    ...
                    <div class="col-12">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="deskripsi_kegiatan" class="form-control @error('deskripsi_kegiatan') is-invalid @enderror"
                                rows="5" placeholder="Enter Deskripsi Kegiatan">{{ old('deskripsi_kegiatan') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="skala_kegiatan"
                                class="form-control @error('skala_kegiatan') is-invalid @enderror">
                                <option value="">Pilih Skala Kegiatan</option>
                                <option value="daerah" {{ old('skala_kegiatan') == 'daerah' ? 'selected' : '' }}>Daerah
                                </option>
                                <option value="provinsi" {{ old('skala_kegiatan') == 'provinsi' ? 'selected' : '' }}>
                                    Provinsi</option>
                                <option value="nasional" {{ old('skala_kegiatan') == 'nasional' ? 'selected' : '' }}>
                                    Nasional</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="kebutuhan_dana"
                                class="form-control @error('kebutuhan_dana') is-invalid @enderror"
                        ...
                        <div class="mb-3">
                            ...
                            @enderror
                            <small class="">
                                berkas yang dilampirkan yaitu file proposal kegiatan, SK Organisasi Kepemudaan, AD/ART, Akta
                                Notaris Organisasi, NPWP, Scan Buku Tabungan, Surat Terdaftar di Kementrian Hukum dan HAM, KTP
                                Pengurus (Ketua/ Sekretaris/ Bendahara). File PDF (Link Drive di bagikan untuk diakses)
