            ...
            <div class="row">
                ...
                <div class="col-md-8 col-xl-9 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                    <a href="{{ route('admin.' . $active . '.create') }}" class="btn btn-info d-flex align-items-center">
                        <i class="ti ti-plus text-white me-1 fs-5"></i> Add Berita
                    </a>
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        @foreach ($beritas as $berita)
                            <tr>
                                ...
                                <td>
                                    @if ($berita->cover)
                                        <img src="{{ asset('public/uploads/berita',$berita->cover) }}" alt="Cover" style="max-width: 100px;">
                                    @else
                                        No Cover
                                    @endif
                                </td>
                                <td>
                                    <a href="{{ route('admin.' . $active . '.show', $berita->id) }}"
                                        class="btn btn-sm btn-secondary">
                                        <i class="ti ti-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.' . $active . '.edit', $berita->id) }}"
                                        class="btn btn-sm btn-warning">
                                        <i class="ti ti-pencil"></i>
                                    </a>
                                    <form action="{{ route('admin.' . $active . '.destroy', $berita->id) }}"
        ...
        <div class="card-body">
            <div class="alert alert-warning mb-0" role="alert">
                <div class="d-flex gap-2 align-items-center">
                    ...
                    <p class="mb-0">
                        No berita data yet. <a href="{{ route('admin.'. $active . '.create') }}">Add</a> now.
                    </p>
                </div>
            </div>
        </div>
